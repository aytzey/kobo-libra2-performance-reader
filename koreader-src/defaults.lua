...
-- Libra 2 overlay: keep one page ready without rendering two PDF pages after every turn.
DHINTCOUNT = 1,
...
DTAP_ZONE_MENU_EXT = {x = 3/8, y = 0, w = 1/4, h = 1/8}, -- taller, narrower extension
DTAP_ZONE_CONFIG = {x = 1/5, y = 9/10, w = 3/5, h = 1/10},
DTAP_ZONE_CONFIG_EXT = {x = 1/4, y = 5/6, w = 1/2, h = 1/6}, -- taller, narrower extension
...
-- Poll interval while waiting for a background k2pdfopt reflow/render context.
-- Lower values trade a few extra wakeups for better foreground latency.
DKOPTREADER_BACKGROUND_WAIT_US = 100000,
...
DKOPTREADER_DISABLE_OCR_FALLBACK = false,                  -- skip Tesseract fallback unless explicitly re-enabled
...
DMINIBAR_CONTAINER_HEIGHT = 12,  -- Larger means more padding at the bottom, at the risk of eating into the last line
