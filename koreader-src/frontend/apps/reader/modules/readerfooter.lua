...
function ReaderFooter:_updateFooterText(force_repaint, full_repaint)
    ...
    if G_reader_settings:isTrue("libra2_skip_unchanged_footer_update")
            and not force_repaint
            and not full_repaint
            and self._last_footer_layout_text == text
            and self._last_footer_layout_screen_width == self._saved_screen_width
            and self._last_footer_layout_screen_height == self._saved_screen_height then
        return
    end
    ...
    self.horizontal_group:resetLayout()
    self._last_footer_layout_text = text
    self._last_footer_layout_screen_width = self._saved_screen_width
    self._last_footer_layout_screen_height = self._saved_screen_height
